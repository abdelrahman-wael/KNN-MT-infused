...
class TranslationTask(FairseqTask):
    ...
    def build_dataset_for_inference(self, src_tokens, src_sizes, tgt_tokens=None, tgt_sizes=None,dic=None):
        return LanguagePairDataset(src=src_tokens, src_sizes=src_sizes, src_dict=dic,tgt=tgt_tokens, tgt_sizes=tgt_sizes ,tgt_dict=dic )
