...
def get_parser(desc, default_task="translation"):
    ...
    # fmt: off
    parser.add_argument("--dstore-training-data-folder",type=str)
    parser.add_argument("--test-data-folder",type=str)
    parser.add_argument("--adaptive-temperature",type=int,default=100,help='temperature used to determine adaptive weight given to knn')
...
def add_generation_args(parser):
    ...
    group.add_argument("--test-count", default=2500,
                help="source language")
