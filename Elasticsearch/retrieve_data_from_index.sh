...
curl -s -XGET "http://${ip}:${port}/${index_name}/_msearch?pretty" -H 'Content-Type: application/json' --data-binary "@${data_path}"

# echo -e "\nStep 3: GET elastic current indecies info"
# curl -sk -XGET http://10.32.160.10:40001/_cat/indices?v
